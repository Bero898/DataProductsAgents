...
async def compatibility_assessment(dp1_path, dp2_path, investment: float = 3.0, n_round: int = 3):
    ...
    alice = DPOwner(name="Alice", data_product=dp1, opponent_name="Bob", opponent_2_name="Bob2")
    bob = DPOwner(name="Bob", data_product=dp2, opponent_name="Alice", opponent_2_name="Alice2")
