...
async def compatibility_assessment(dp1_path, dp2_path, investment: float = 3.0, n_round: int = 3):
    ...
    alice2 = ContextDPOwner(name="Alice2", data_product=dp1, opponent_name="Bob2", broker_name="Connor")
    bob2 = ContextDPOwner(name="Bob2", data_product=dp2, opponent_name="Alice2", broker_name="Connor")
